...
public class DBUtils {
    ...
    static {
        try {
            ...
            connection = DriverManager.getConnection((String) dbProp.getOrDefault("JDBC_URL", ""), (String) dbProp.getOrDefault("JDBC_USERNAME", ""), (String) dbProp.getOrDefault("JDBC_PASSWORD", ""));
            ...
            Logger.getLogger(DBUtils.class.getName()).log(Level.SEVERE, "Can't connection to Database", ex);
        }
    }
